...
public class Principal {
    ...
    private void filtrarSeriePorTemporadaENota() {
    ...
    private void buscarSeriePorCategoria() {
        ...
        System.out.println("Series da categorias: " + nomeGenero);
